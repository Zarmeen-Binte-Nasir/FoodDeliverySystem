              ...
              builder: (context, menuSnap) {
                ...
                return CustomScrollView(
                  slivers: [
                    ...
                    SliverToBoxAdapter(
                        child: _buildHeroStats(totalRestaurants,
                            totalOrders, avgRating, popularCount)),
                    SliverToBoxAdapter(
                        child: _buildHighlightRow(totalMenuItems)),
                    SliverToBoxAdapter(
                      child: Padding(
                        padding:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text('$totalRestaurants total',
                                style: caption.copyWith(color: kPrimary)),
                          ],
                        ),
                      ),
                    ),
...
class _BigStatCard extends StatelessWidget {
  ...
  const _BigStatCard({super.key, required this.data});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(data.value,
              style:
              displayXL.copyWith(color: data.color, fontSize: 28)),
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              const Spacer(),
              // TODO: Replace with real sum from orders collection
              Text('\$8,240',
                  style: displayXL.copyWith(
                      color: Colors.white, fontSize: 26)),
              const SizedBox(height: 2),
              Text('Revenue',
                  style: caption.copyWith(color: Colors.white60)),
            ],
          ),
        ],
      ),
...
class _ActivityCard extends StatelessWidget {
  ...
  const _ActivityCard({super.key, required this.totalMenuItems});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 2),
          Text('Menu Items',
              style: caption.copyWith(color: Colors.white38)),
        ],
      ),
    );
  }
