...
import 'package:food_delivery_system/screens/auth/signup_screen.dart';
import 'package:food_delivery_system/screens/user/home_screen.dart';
import 'package:food_delivery_system/screens/auth/forgot_password_screen.dart';
import 'package:food_delivery_system/screens/admin/admin_dashboard_tab.dart';
import 'package:food_delivery_system/screens/restaurant/restaurant_home_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
      ...
      if (mounted) {
        if (dbRole == 'Admin') {
          Navigator.pushReplacement(context,
              MaterialPageRoute(builder: (_) => const AdminDashboardTab()));
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (mounted) {
        if (dbRole == 'Admin') {
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const AdminDashboardTab()));
        } else if (dbRole == 'Restaurant') {
